/**
 * The validity window of a guest gate access (specs/gate-access-sowel-connector.md §3.1).
 *
 ...
 * what the guest reads. It is computed from the live reservation and published to the house whenever the
 * dates, the times or the lodging change (specs/gate-access-sowel-connector.md §3.1): moving the dates moves
