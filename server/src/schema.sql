...
CREATE TABLE IF NOT EXISTS options (
    ...
    price REAL NOT NULL DEFAULT 0,
    createdAt TEXT DEFAULT (datetime('now'))
  , autoOptionType TEXT, autoEnabled INTEGER NOT NULL DEFAULT 0, autoPricingMode TEXT NOT NULL DEFAULT 'fixed', autoFullNightThreshold TEXT, optionProgressiveTiers TEXT NOT NULL DEFAULT '[]', countsAsBedLinen INTEGER NOT NULL DEFAULT 0, countsAsBathroomLinen INTEGER NOT NULL DEFAULT 0, linenIncludesSingle INTEGER NOT NULL DEFAULT 1, linenIncludesDouble INTEGER NOT NULL DEFAULT 1, linenIncludesBaby INTEGER NOT NULL DEFAULT 1, towelLargePerPerson INTEGER NOT NULL DEFAULT 1, towelMediumPerPerson INTEGER NOT NULL DEFAULT 0, towelSmallPerPerson INTEGER NOT NULL DEFAULT 1, titleEn TEXT NOT NULL DEFAULT '', breakfastTime TEXT DEFAULT '09:00', archivedAt TEXT, showsPlanningCard INTEGER NOT NULL DEFAULT 0, cardRepeat TEXT NOT NULL DEFAULT 'once', planningCardDate TEXT, planningCardTimes TEXT, scopeMigratedV2 INTEGER NOT NULL DEFAULT 0);
...
CREATE TABLE IF NOT EXISTS properties (
    ...
    createdAt TEXT DEFAULT (datetime('now')),
    updatedAt TEXT DEFAULT (datetime('now'))
  , touristTaxMode TEXT DEFAULT 'per_day_per_person', touristTaxPercentage REAL DEFAULT 0, touristTaxFixedAmount REAL DEFAULT 0, touristTaxDepartmentPercentage REAL DEFAULT 0, basePriceIncludedGuests INTEGER DEFAULT 0, extraGuestPrice REAL DEFAULT 0, nameArticle TEXT DEFAULT 'au');
