...
CREATE TABLE IF NOT EXISTS app_settings (
  ...
  , companyName TEXT DEFAULT '', companyAddress TEXT DEFAULT '', companySiret TEXT DEFAULT '', companyTva TEXT DEFAULT '', companyIban TEXT DEFAULT '', companyBic TEXT DEFAULT '', companyBankName TEXT DEFAULT '', quoteFooterText TEXT DEFAULT '', quoteValidityDays INTEGER DEFAULT 30, companyLogoPath TEXT DEFAULT '', companyEmail TEXT DEFAULT '', companyPhone TEXT DEFAULT '', smtpHost TEXT DEFAULT '', smtpSecure INTEGER NOT NULL DEFAULT 0, smtpUsername TEXT DEFAULT '', smtpPasswordEncrypted TEXT DEFAULT '', smtpFromEmail TEXT DEFAULT '', smtpFromName TEXT DEFAULT '', publicUrl TEXT DEFAULT '', laundryWeekday INTEGER NOT NULL DEFAULT 2, bedLinenStockSingle INTEGER NOT NULL DEFAULT 0, bedLinenStockDouble INTEGER NOT NULL DEFAULT 0, bedLinenStockBaby   INTEGER NOT NULL DEFAULT 0, towelStockLarge     INTEGER NOT NULL DEFAULT 0, towelStockMedium    INTEGER NOT NULL DEFAULT 0, towelStockSmall     INTEGER NOT NULL DEFAULT 0, vatRate REAL NOT NULL DEFAULT 10, defaultCommissionAccountNumber TEXT NOT NULL DEFAULT '622600', vatRateCommission REAL NOT NULL DEFAULT 20, quoteFooterTextEn TEXT DEFAULT '', notificationsEnabled INTEGER NOT NULL DEFAULT 1, notificationRecipientEmail TEXT DEFAULT '', qontoAccessTokenEncrypted  TEXT DEFAULT '', qontoRefreshTokenEncrypted TEXT DEFAULT '', qontoTokenExpiresAt        TEXT DEFAULT '', qontoConnectionId          TEXT DEFAULT '', qontoConnectionStatus      TEXT DEFAULT 'not_connected', qontoConnectedAt           TEXT DEFAULT '', qontoEnvironment TEXT DEFAULT '', qontoClientId TEXT DEFAULT '', qontoClientSecretEncrypted TEXT DEFAULT '', qontoStagingTokenEncrypted TEXT DEFAULT '', qontoWebhookSecretEncrypted TEXT DEFAULT '', publicSiteOrigin TEXT DEFAULT '', qontoLastCheckAt TEXT DEFAULT '', qontoLastSuccessAt TEXT DEFAULT '', qontoLastErrorAt TEXT DEFAULT '', qontoLastErrorCode TEXT DEFAULT '', qontoLastErrorMessage TEXT DEFAULT '', qontoLastErrorOrigin TEXT DEFAULT '', qontoWebhookSubscriptionId TEXT DEFAULT '', qontoWebhookCallbackUrl TEXT DEFAULT '', portalCode TEXT DEFAULT '', notifyIcalReservationEnabled INTEGER NOT NULL DEFAULT 1, towelStockBathMat INTEGER NOT NULL DEFAULT 0, meteoFranceApiKeyEncrypted TEXT DEFAULT '', googleOAuthRefreshTokenEncrypted TEXT DEFAULT '', googleOAuthConnectedEmail TEXT DEFAULT '', googleOAuthConnectedAt TEXT DEFAULT '', googleCalendarSummary TEXT DEFAULT '', googleLastSyncAt TEXT DEFAULT '', googleLastSyncOk INTEGER DEFAULT NULL, googleLastSyncDetail TEXT DEFAULT '', cancellationCompensationAccount TEXT NOT NULL DEFAULT '75880000', vatRateCancellationCompensation REAL NOT NULL DEFAULT 0, neatEnvironment TEXT NOT NULL DEFAULT 'staging', neatClientId TEXT DEFAULT '', neatClientSecretEncrypted TEXT DEFAULT '', neatSalesChannelId TEXT DEFAULT '', neatSalesChannelLabel TEXT DEFAULT '', neatContractId TEXT DEFAULT '', neatContractLabel TEXT DEFAULT '', neatPaymentMethodId TEXT DEFAULT '', neatPaymentMethodKind TEXT DEFAULT '', neatPaymentMethodLabel TEXT DEFAULT '', neatFieldMappingJson TEXT DEFAULT '', neatContractFieldsJson TEXT DEFAULT '', neatMarginPercent REAL DEFAULT NULL);
...
-- specs/cancellation-compensation.md §5 — what a platform owes (or has paid) for a cancelled stay.
-- Standalone on purpose: approving the cancellation deletes the reservation, so the row holds a
-- frozen snapshot instead of foreign keys.
...
CREATE TABLE IF NOT EXISTS pricing_rules (
    ...
    extraGuestTiers TEXT DEFAULT NULL,
    FOREIGN KEY (propertyId) REFERENCES properties(id) ON DELETE CASCADE
  );
...
CREATE TABLE IF NOT EXISTS properties (
    ...
    balanceDaysBefore INTEGER DEFAULT 30,
    cancelAfterBalanceDueDays INTEGER NOT NULL DEFAULT 7,
...
CREATE INDEX IF NOT EXISTS idx_cancellation_comp_status
    ON cancellation_compensations(status);

CREATE INDEX IF NOT EXISTS idx_cancellation_comp_received
    ON cancellation_compensations(receivedDate);

CREATE INDEX IF NOT EXISTS idx_reservations_cancelled
    ON reservations(cancelledAt);
