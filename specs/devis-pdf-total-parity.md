...
|---|---|
| `offeredOptionIds` | Every **offered** option is re-billed at full price **and** loses its `includedInRate` tag, so its value is no longer deducted from the tourist-tax base (specs/tariff-recipes §3.8 rules 48-49) |
