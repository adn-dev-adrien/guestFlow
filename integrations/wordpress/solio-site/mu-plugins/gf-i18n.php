...
function gf_i18n_dictionnaire() {
    ...
    $d = array(
        'fr' => array(
            ...
            'resa_la_session'      => 'la session',
            'resa_tarif_degressif' => 'tarif dégressif',
            'resa_par_personne'    => 'par personne',
        ...
        'en' => array(
            ...
            'resa_la_session'      => 'the session',
            'resa_tarif_degressif' => 'sliding scale',
            'resa_par_personne'    => 'per person',
