/**
 * BaguetteIcon — baguette pictogram for « Pain » (breakfast composition).
 *
 * Material Icons has no baguette, so this wraps the « baguette » glyph from the Material
 * Design Icons set (Pictogrammers, Apache-2.0) in a MUI SvgIcon — same approach as
 * `WheatIcon`; takes the same props (color, sx, fontSize) as any @mui/icons-material icon.
 */
import { createSvgIcon } from '@mui/material/utils';
import React from 'react';

const BaguetteIcon = createSvgIcon(
