/**
 * WheatIcon — wheat-ear pictogram for « Céréales » (breakfast composition).
 *
 * Material Icons has no wheat ear, so this wraps the « barley » glyph from the
 * Material Design Icons set (Pictogrammers, Apache-2.0) in a MUI SvgIcon: it takes
 * the same props (color, sx, fontSize) as any @mui/icons-material icon.
 */
import { createSvgIcon } from '@mui/material/utils';
import React from 'react';

const WheatIcon = createSvgIcon(
