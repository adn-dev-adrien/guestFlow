 ...
 *
 * The installed version and its updates, and the public URL of the application — used in the
 * emails, the Google return address and the Qonto notifications, so it lives here rather than in
 * the SMTP card (rule 16). It is typed, never guessed from a request host.
 */
